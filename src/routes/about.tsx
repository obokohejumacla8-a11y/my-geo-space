...
const experience = [
  ...
  },
  {
    ...
    role: "GIS Trainee (Part-Time)",
    org: "Geospatial Survey & Mapping Solutions | Lae, PNG",
    points: [
      "Field work exposure through community engagement with local coffee farmers. Funded and managed by Abt Associates with the aim to support farmers, particularly women, to improve their production practices and achieve higher yields and better prices for their coffee.",
      'Project Title: "DCP-2019-016_Morobe E-Coffee Project Phase 1 – Data Collection"',
      "Conducted GIS field data collection.",
      "Integrated mobile data collection systems.",
      "Conducted GIS spatial analysis using QGIS.",
      "Delivered GIS dataset supporting coffee farmer development project.",
      "Supported GIS mapping and spatial data processing.",
    ],
  },
  {
    period: "2019",
