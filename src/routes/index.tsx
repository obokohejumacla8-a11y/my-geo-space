...
import { ArrowRight, MapPin, Layers, Database, BarChart3, Wrench, Building2, Trees, Waves, ShieldCheck, Compass } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "Hejumacla T. Oboko — An enthusiast GIS Specialist & WebGIS Developer" },
      {
        name: "description",
        content:
          "Results-oriented GIS Professional building WebGIS platforms, spatial analyses and mobile data workflows across Papua New Guinea.",
      },
    ],
  }),
  component: Index,
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:py-40">
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            I'm <span className="text-foreground font-medium">Hejumacla T. Oboko</span> — a GIS Specialist building
            WebGIS platforms, spatial analyses and mobile field workflows that move communities, municipalities and
            ecosystems toward the SDGs.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-md border border-border bg-card/60 px-5 py-3 text-sm font-medium hover:border-primary transition"
            >
              Get in touch
            </Link>
          </div>
        ...
        <div className="mt-4 surface-card overflow-hidden grid md:grid-cols-2">
          ...
          <div className="p-8 md:p-10">
            <div className="flex flex-wrap gap-2">
              {featured.sdgs.map((s) => (
                <span key={s} className="rounded-full bg-secondary/15 text-secondary text-xs font-mono px-2.5 py-1">
                  {s}
                </span>
              ))}
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.filter((p) => p.slug !== featured.slug).map((p) => (
            <Link
              ...
              to="/projects/$slug"
              params={{ slug: p.slug }}
              className="surface-card overflow-hidden hover-lift group block"
            >
              ...
              <div className="p-6">
                <div className="flex gap-1.5 flex-wrap mb-3">
                  {p.sdgs.map((s) => (
                    <span key={s} className="text-[10px] font-mono uppercase tracking-wider text-secondary">
                      {s}
                    </span>
                  ))}
                </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-base md:text-lg text-muted-foreground leading-relaxed">
              From the volcanic ridges of New Britain to the Sepik wetlands and the urban frontier of Lae — Papua New
              Guinea is one of the most biologically and culturally rich landscapes on Earth. Yet much of it remains
              under-mapped. GIS is how we close that gap, turning terrain, rivers, villages and assets into the spatial
              intelligence our country needs to grow sustainably.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {[
              {
                icon: Building2,
                title: "Smart municipalities",
                body: "WebGIS for land, property and revenue management in fast-growing urban centres.",
              },
              {
                icon: Trees,
                title: "Forest & land care",
                body: "Monitoring logging, oil-palm expansion and NDVI change to protect customary land.",
              },
              {
                icon: Waves,
                title: "Water & WaSH",
                body: "Mapping groundwater potential and rural water infrastructure for healthier communities.",
              },
              {
                icon: ShieldCheck,
                title: "Climate resilience",
                body: "Hazard, drainage and exposure mapping to prepare provinces for a changing climate.",
              },
      ...
      <section className="mx-auto max-w-4xl px-6 py-24 text-center">
        ...
        <blockquote className="mt-6 font-display text-2xl md:text-3xl leading-snug">
          "GIS is not just about making maps; it's about providing the{" "}
          <span className="text-gradient">spatial intelligence</span> necessary to build sustainable cities, protect our
          natural resources, and empower local communities through data-driven decisions."
        </blockquote>
      </section>
    </>
  );
